...
const translations = {
  ...
  'en': {
    ...
    'give-origin': 'Enter your starting point',
    ...
    'parking': 'Parking',
    'parking-space': 'Free parking space',
    'pay-attention': 'N.B.',
    ...
    'road-conditions-2hour': '+ 2 h',
    'road-conditions-4hour': '+ 4 h',
    'road-conditions-6hour': '+ 6 h',
    'road-conditions-12hour': '+ 12 h',
    'road-conditions-now': 'Now',
    'road-weather': 'Road weather',
    'road-weather-air': 'Air',
    'road-weather-condition': 'Condition',
    'road-weather-road': 'Road',
    'road-weather-time': 'Time',
    'road-weather-weather': 'Weather',
    'road-weather-wind': 'Wind',
    'route': 'Route',
    ...
    'speed-averages': 'Average speeds',
    'speed-limit': 'Speed limit',
    'splash-and-select-start-location': 'and select start location',
    ...
    'splash-intro': 'The service offers journey planning for public transport in Oulu, Ii, Kempele, Liminka, Lumijoki, Muhos and Tyrnävä areas. The service includes public transportation, walking, cycling and motoring.',
    'splash-locating': 'Detecting location',
    'splash-or-choose': 'or select your starting point',
    'splash-please-allow-positioning': 'To get the most out of the service, enable location services.',
    'splash-select-mode-of-transport': 'Select mode of transport',
    'splash-use-positioning': 'Use location services',
    'splash-welcome': 'Welcome to the Oulunliikenne.fi 2.0 pilot service!',
    ...
    'temperature-road': 'Road temperature',
    ...
    'to-stop': 'To stop',
    'today': 'Today',
    'toggle-bulletins': 'Incidents',
    'toggle-bus-lines-map': 'Bus lines map',
    'toggle-cameras': 'Cameras',
    'toggle-car-monitors': 'Monitoring',
    'toggle-car-parks': 'Parking',
    'toggle-events': 'Events',
    'toggle-outdoor-gyms': 'Outdoor gyms',
    'toggle-road-conditions': 'Driving weather',
    'toggle-traffic-fluency': 'Congestions',
    'toggle-weather-forecast': 'Weather forecast',
    'toggle-weather-stations': 'Road weather',
    'tomorrow': 'Tomorrow',
    'traffic-amount': 'Traffic amount',
    'traffic-camera': 'Traffic camera',
    'traffic-fluency': 'Congestion',
    'traffic-fluency-30': '+ 30 min',
    'traffic-fluency-now': 'Now',
    ...
    'weather': 'Weather',
    'weather-air': 'Air weather',
    'weather-at-destination': 'Weather at the destination',
    'weather-forecast': 'Weather Forecast {city}',
    'weather-forecast-provider': 'Forecast provided by ',
    'weather-road': 'Road weather',
  ...
  'fi': {
    ...
    'destination-pages': 'Kohteen sivut',
    ...
    'minute-short': 'min',
    'minutes': 'min',
    'monitoring-point': 'Seurantapiste',
    'navigate': 'Navigoi',
    'near-you': 'Lähelläsi',
    'nearest': 'Lähimmät',
    ...
    'parking': 'Pysäköinti',
    'parking-space': 'Vapaita paikkoja',
    'pay-attention': 'Huom!',
    ...
    'right-now': 'Juuri nyt',
    'road': 'Tie {number} {name}',
    'road-conditions-2hour': '+ 2 h',
    'road-conditions-4hour': '+ 4 h',
    'road-conditions-6hour': '+ 6 h',
    'road-conditions-12hour': '+ 12 h',
    'road-conditions-now': 'Nyt',
    'road-weather': 'Tiesää',
    'road-weather-air': 'Ilma',
    'road-weather-condition': 'Ajokeli',
    'road-weather-road': 'Tie',
    'road-weather-time': 'Aika',
    'road-weather-weather': 'Sää',
    'road-weather-wind': 'Tuuli',
    'route': 'Linja',
    ...
    'speed-averages': 'Keskinopeudet',
    'speed-limit': 'Nopeusrajoitus',
    'splash-and-select-start-location': 'ja valitse lähtöpaikkasi',
    ...
    'splash-intro': 'Palvelun tarjoaa joukkoliikenteen reittisuunnittelua Oulun, Iin, Kempeleen, Limingan, Lumijoen, Muhoksen ja Tyrnävän alueella. Palvelu kattaa joukkoliikenteen, kävelyn, pyöräilyn ja yksityisautoilun rajatuilta osin.',
    ...
    'splash-select-mode-of-transport': 'Valitse kulkuväline',
    'splash-use-positioning': 'Käytä paikannusta',
    'splash-welcome': 'Tervetuloa Oulunliikenne.fi 2.0 -pilottipalveluun!',
    ...
    'temperature-air': 'Ilman lämpötila',
    'temperature-road': 'Tien lämpötila',
    ...
    'to-stop': 'Pysäkille',
    'today': 'Tänään',
    'toggle-bulletins': 'Tiedotteet',
    'toggle-bus-lines-map': 'Linjakartta',
    'toggle-cameras': 'Kamerat',
    'toggle-car-monitors': 'Seuranta',
    'toggle-car-parks': 'Pysäköinti',
    'toggle-events': 'Tapahtumat',
    'toggle-outdoor-gyms': 'Kuntoilupuistot',
    'toggle-road-conditions': 'Ajokeli',
    'toggle-traffic-fluency': 'Ruuhkat',
    'toggle-weather-forecast': 'Sääennuste',
    'toggle-weather-stations': 'Tiesää',
    'tomorrow': 'Huomenna',
    'traffic-amount': 'Liikennemäärät',
    'traffic-camera': 'Liikennekamera',
    'traffic-fluency': 'Ruuhkatilanne',
    'traffic-fluency-30': '+ 30 min',
    'traffic-fluency-now': 'Nyt',
    ...
    'weather-forecast': 'Sääennuste {city}',
    'weather-forecast-provider': 'Sääennusteen tarjoaa ',
    'weather-road': 'Keli',
